...
export const CAST_ROLES: { id: CastRole; label: string; emoji: string; hint: string }[] = [
  {
    ...
    label: "Audition lead",
    emoji: "💋",
    hint: "Charmer auditions — bedre casting-rull.",
  },
  {
    id: "shooting",
    label: "Performer",
    emoji: "🎬",
    hint: "På sett under innspilling — kvalitet + suksess.",
  },
  {
    id: "editing",
    label: "Crew/Continuity",
    emoji: "🎞️",
    hint: "Hjelper i redigering — færre rework.",
  },
  {
    id: "release",
    label: "PR & Promo",
    emoji: "📣",
    hint: "Pusher kampanjen ved utgivelse — mindre flopp-risiko.",
  },
];

export const ROLE_LABEL: Record<CastRole, string> = Object.fromEntries(
  CAST_ROLES.map((r) => [r.id, r.label]),
