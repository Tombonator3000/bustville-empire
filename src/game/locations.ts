...
export const DISTRICTS: District[] = [
  {
    id: "park",
    name: "Bustville Trailer Park",
    image: mapTrailerDay,
    nightImage: mapTrailerNight,
    unlockLevel: 1,
    tagline: "Rust, røyk og rå muligheter.",
  },
  {
    id: "downtown",
    name: "Downtown Bustville",
    image: mapDowntown,
    unlockLevel: 3,
...
export const LOCATION_DEFS: Record<LocationId, LocationDef> = {
  ...
  distrib: {
    id: "distrib",
    name: "Reel Republic Distribution",
    district: "downtown",
    image: distribImg,
    description:
      "Sigarrøyk og VHS-stabler. Mr. Halloran selger filmene dine til drive-ins og kabel-TV.",
    openHours: [10, 18],
    unlockLevel: 3,
  },
  clinic: {
    id: "clinic",
    name: "Doc Lonnie's Clinic",
    district: "park",
    image: clinicImg,
...
export const LOCATION_ACTIONS: Record<LocationId, Action[]> = {
  trailer: [
    {
      id: "sleep",
      label: "Sov til morgen",
      emoji: "😴",
      hours: 0,
      desc: "Hopper til kl 07. Full stamina.",
    },
    ...
    { id: "visit", label: "Ta imot besøk", emoji: "🚪", hours: 1 },
    {
      ...
      emoji: "🎬",
      hours: 0,
      desc: "Åpner film-pipeline (Quickie tilgjengelig her).",
    },
    { id: "roster", label: "Roster & Trening", emoji: "💋", hours: 0 },
    {
      ...
      emoji: "📋",
      hours: 0,
      desc: "Scout and hire local performers from the trailer office.",
    },
    {
      id: "helpWanted",
      ...
      emoji: "🧰",
      hours: 0,
      desc: "Hire cheap local crew and upgrade your staff.",
    },
  ...
  moonshine: [
    ...
    {
      id: "distillUp",
      label: "Oppgrader destilleri",
      emoji: "🛠️",
      hours: 0,
      desc: "Engangs-investering.",
    },
  ],
  bar: [
  ...
  sheriff: [
    {
      ...
      emoji: "💵",
      hours: 1,
      desc: "Kostnad skalerer med heat. 3 dagers immunitet. Gjentatt bribing innen 5 dager = dyrere & mindre effekt.",
    },
  ...
  gas: [
    ...
    {
      id: "gasCondoms",
      label: "Kjøp condoms (3)",
      emoji: "🧪",
      hours: 1,
      desc: "-$80. Skitne pakker bak disken — funker.",
    },
    {
      id: "postFlyer",
      label: "Post casting flyer",
      emoji: "📣",
      hours: 1,
      desc: "-$40. Adds a local talent lead to the Casting Board.",
    },
  ],
  forest: [
    {
      ...
      emoji: "🌲",
      hours: 2,
      desc: "Reduce heat by staying out of sight.",
    },
    {
      id: "searchProps",
      label: "Search for props",
      emoji: "🔦",
      hours: 2,
      desc: "Chance to find cheap supplies or useful junk.",
    },
    {
      id: "hideStash",
      label: "Gjem moonshine",
      emoji: "🌲",
      hours: 1,
      desc: "Reduserer razzia-tap.",
    },
  ],
  loft: [
    {
      id: "produce",
      label: "🎬 Start filmproduksjon",
      emoji: "🎬",
      hours: 0,
      desc: "Åpner pipeline — Glamour Feature låst opp her.",
    },
  ...
  velvet: [
    {
      ...
      emoji: "🤝",
      hours: 3,
      desc: "+rep, kanskje agent-ringer.",
    },
    { id: "party", label: "Kast fest", emoji: "🎉", hours: 4 },
    {
      id: "scoutVip",
      label: "Scout VIP-jente",
      emoji: "💎",
      hours: 3,
      desc: "Dyrt, høy kvalitet.",
    },
  ],
  bank: [
    {
      ...
      emoji: "💰",
      hours: 2,
      desc: "+$5000 nå, betal $6500 om 4 uker.",
    },
  ...
  studio: [
    {
      ...
      emoji: "🎬",
      hours: 0,
      desc: "Pipeline — Feature & Blockbuster låst opp her.",
    },
  ...
  electro: [
    {
      id: "buyFilm",
      label: "Kjøp filmstock (5)",
      emoji: "📼",
      hours: 1,
      desc: "-$300, +5 ruller. Trengs i Innspilling.",
    },
    {
      id: "upgradeCamera",
      label: "Oppgrader kamera",
      emoji: "📷",
      hours: 0,
      desc: "Bedre kvalitet & risiko.",
    },
  ...
  boutique: [
    {
      id: "buyCostume",
      label: "Kjøp kostymer (3)",
      emoji: "👗",
      hours: 1,
      desc: "-$240, +3 kostymer. Brukes i Innspilling.",
    },
    {
      id: "wardrobe",
      label: "Garderobe-økt",
      emoji: "💄",
      hours: 2,
      desc: "Buff jentenes pop midlertidig.",
    },
  ],
  casting: [
    {
      ...
      emoji: "🎟️",
      hours: 2,
      desc: "-$180, +1 audition-voucher (kreves i Casting-steget).",
    },
    {
      id: "openCall",
      label: "Hold open call",
      emoji: "📣",
      hours: 4,
      desc: "-$500, sjanse for ny jente fra køen.",
    },
  ],
  distrib: [
    {
      id: "signDeal",
      label: "Signer distribusjons-deal",
      emoji: "🤝",
      hours: 2,
      desc: "Engangs-bonus på neste utgivelse.",
    },
    {
      id: "presell",
      label: "Pre-sell katalog",
      emoji: "💼",
      hours: 2,
      desc: "Få cash på backlog.",
    },
    {
      id: "campaignS",
      label: "Marketing: lokalt",
      emoji: "📣",
      hours: 1,
      desc: "-$300. +20% på neste utgivelse.",
    },
    {
      id: "campaignM",
      label: "Marketing: regional",
      emoji: "📺",
      hours: 2,
      desc: "-$800. +50% på neste utgivelse.",
    },
    {
      id: "campaignL",
      label: "Marketing: nasjonal",
      emoji: "🚀",
      hours: 3,
      desc: "-$2000. +100% på neste utgivelse.",
    },
    {
      id: "fansRomance",
      label: "Fanboost: Romance",
      emoji: "💕",
      hours: 3,
      desc: "-$400. +60 Romance-fans (varig). Stor fanbase = høyere payout & lavere flopp på Romance-utgivelser.",
    },
    {
      id: "fansWild",
      label: "Fanboost: Wild",
      emoji: "🎉",
      hours: 3,
      desc: "-$400. +60 Wild-fans (varig).",
    },
    {
      id: "fansGlamour",
      label: "Fanboost: Glamour",
      emoji: "💎",
      hours: 3,
      desc: "-$400. +60 Glamour-fans (varig).",
    },
    {
      id: "fansFetish",
      label: "Fanboost: Fetish",
      emoji: "⛓️",
      hours: 3,
      desc: "-$400. +60 Fetish-fans (varig).",
    },
  ],
  clinic: [
    ...
    {
      id: "detox",
      label: "Detox en stjerne",
      emoji: "🧴",
      hours: 3,
      desc: "-$300, fjerner cooldown på en jente.",
    },
    {
      id: "buyCondoms",
      label: "Kjøp condoms (10)",
      emoji: "🧪",
      hours: 1,
      desc: "-$200. Brukes auto i intense scener — beskytter 100%.",
    },
    {
      id: "antibiotics",
      label: "Antibiotika-kur",
      emoji: "💊",
      hours: 2,
      desc: "-$400. Kurerer Chlamydia/Gonorrhea på valgt jente.",
    },
    {
      id: "steroids",
      label: "Steroid-blokker",
      emoji: "💉",
      hours: 2,
      desc: "-$700. Undertrykker enhver STD i 5 dager (også Herpes/HIV).",
    },
    {
      id: "enhanceLips",
      label: "Lip Fillers",
      emoji: "💋",
      hours: 2,
      desc: "-$600, +beauty. 2 dager restitusjon. Velg jente.",
    },
    {
      id: "enhanceFit",
      ...
      emoji: "🏋️",
      hours: 3,
      desc: "-$800, +performance. 3 dager restitusjon.",
    },
    {
      id: "enhanceBoob",
      label: "Boob Job",
      emoji: "🍒",
      hours: 4,
      desc: "-$1800, +beauty solid. 5 dager restitusjon. Risiko 10%.",
    },
    {
      id: "enhanceButt",
      label: "Butt Lift",
      emoji: "🍑",
      hours: 5,
      desc: "-$2200, +popularity. 7 dager restitusjon. Risiko 12%.",
    },
  ],
};

export function getDistrictTransitionLock(
  state: GameState,
  target: DistrictId,
  ...
  if (!canUnlockDowntown(state))
    return { locked: true, reason: formatDowntownRemainingRequirements(state) };
  return { locked: false };
}
