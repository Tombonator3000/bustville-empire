...
export const GIRL_MISSIONS = [
  {
    ...
    basePay: 220,
    rep: 1,
    statKey: "performance" as const,
    min: 0,
  },
  {
    id: "club",
    label: "Strip Club Gig",
    emoji: "💃",
    hours: 6,
    basePay: 380,
    rep: 2,
    statKey: "beauty" as const,
    min: 30,
  },
  {
    id: "onlyfans",
    label: "OnlyFans Grind",
    emoji: "🔥",
    hours: 8,
    basePay: 560,
    rep: 2,
    statKey: "popularity" as const,
    min: 35,
  },
  {
    id: "vip",
...
export const WEBCAM_SHOWS: WebcamShowDef[] = [
  {
    ...
    hue: 320,
    scene: "Solo Stream",
    flavor: "Ringlys, lavendel-filter, 47 betalende seere.",
    cover: coverWebshowSolo,
  },
  {
    id: "lingerie",
    label: "Boudoir Show",
    ...
    hue: 280,
    scene: "Boudoir Show",
    flavor: "Silke, satin og chat-tipsene renner inn.",
    cover: coverWebshowLingerie,
  },
  {
    id: "toys",
    ...
    hours: 3,
    hue: 0,
    scene: "Premium Variety Show",
    flavor: "Premium-kanalen koker. Tipsene renner.",
    cover: coverWebshowToys,
  },
];
...
export const VISIT_TYPES: VisitTypeDef[] = [
  {
    ...
    heat: 2,
    hue: 30,
    scene: "Trucker i sofaen",
    flavor: "Diesel, Marlboro og kontanter i en brun konvolutt.",
    cover: coverVisitTrucker,
  },
  {
    id: "drunk",
    label: "Lokal stamgjest",
    emoji: "🍺",
    level: 1,
    cost: 5,
    basePay: 140,
    ...
    heat: 1,
    hue: 50,
    scene: "Bourbon ved midnatt",
    flavor: "Han bruker mer på øl enn på deg, men betaler i tide.",
    cover: coverVisitDrunk,
  },
  {
    id: "bachelor",
    ...
    heat: 3,
    hue: 290,
    scene: "Utdrikningslag",
    flavor: "Seks fulle gutter, én stjerne, et batteri av iPhones.",
    cover: coverVisitBachelor,
    needsGirl: true,
    risky: true,
  },
  {
    id: "politician",
    label: "Lokalpolitiker",
    emoji: "🎩",
    level: 3,
    cost: 120,
    basePay: 880,
    ...
    heat: 5,
    hue: 220,
    scene: "Senatorens diskré besøk",
    flavor: "Han kom inn med Bibel, går ut med leppestift på kragen.",
    cover: coverVisitPolitician,
    risky: true,
  },
  {
    id: "scout",
    label: "LA-talentspeider",
    emoji: "🕶️",
    level: 3,
    cost: 180,
    basePay: 600,
    ...
    heat: 1,
    hue: 200,
    scene: "Talentspeider fra LA",
    flavor: "Han noterer alt, fra wallpaper til kroppsspråk. Rep-injeksjon.",
    cover: coverVisitScout,
    needsGirl: true,
  },
  {
    id: "vipsuite",
    label: "VIP-suite (privat)",
    emoji: "💎",
    level: 4,
    cost: 280,
    basePay: 1700,
    ...
    hue: 320,
    scene: "VIP-suite",
    flavor: "Champagne, kaviar og en bunke 100-dollar-sedler. Diskresjon ekstra.",
    cover: coverVisitVipsuite,
    needsGirl: true,
    risky: true,
  },
];
...
export const CONTENT_TYPES = [
  ...
  },
  {
    ...
    stamina: 20,
    flavor:
      "En herre i dress dukker opp. Forteller kona at han 'fikser bilen'. Penger skifter hender.",
  },
  {
    id: "moonshine",
    name: "Selg Moonshine",
    ...
    stamina: 10,
    flavor:
      'Sheriff Buck blunker. "Jeg så ingenting." Du gir ham en flaske. Han ser virkelig ingenting.',
  },
  {
    id: "onlyfans",
    name: "OnlyFans-pakke",
  ...
  },
  {
    ...
    stamina: 30,
    flavor:
      "Tyskland, Japan, Brasil. Alle vil ha Bustville-merket. Du signerer kontrakter med gull-penn.",
  },
] as const;
